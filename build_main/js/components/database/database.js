export const testimonios = [
    {
    imagen: 'build_main/img/blackstyle1.webp',
    ...
    {
    imagen: 'build_main/img/rousses1.webp',
    nombre: 'Rousses',
    ...
    {
    imagen: 'build_main/img/cesarjs1.webp',
    nombre: 'Cesar JS',
...
export const fotosDelEstudio = [
    {
        src: "build_main/img/foto-estudio1.webp",
        width:3264,
        height:2448,
    ...
    {
        src: "build_main/img/foto-estudio2.webp",
        width:1249,
        height:937,
        alt: 'foto del estudio',
        title: 'Setup del estudio'
    ...
    {
        src: "build_main/img/foto-estudio3.webp",
        width:6000,
        height:4000,
        alt: 'foto del estudio',
