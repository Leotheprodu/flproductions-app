        ...
        <>
            ...
            <div className="contenedor">
                <SimpleText
                    ...
                    texto={
                        <p>
                            Bienvenida a FLProductions, su estudio de grabación
                            musical de alta calidad dirigido por LeotheProdu.
                            Ofrecemos una amplia gama de servicios musicales,
                            incluyendo la producción de instrumentales,
                            grabaciones, mezclas y masterizaciones con la
                            tecnología de vanguardia y un equipo altamente
                            capacitado. Nuestros ingenieros de sonido,
                            compositores y productores son expertos en lograr un
                            sonido profesional único y de alta calidad. Reserva
                            su sesión de grabación con LeotheProdu y experimenta
                            la diferencia en calidad en FLProductions.
                        </p>
                    }
                />
            ...
            <div className="contenedor acerca-de-nosotros">
                <SimpleText
                    ...
                    texto={
                        <p>
                            Somos un equipo apasionado por la música y la
                            producción de audio. En FLProductions, nos dedicamos
                            a hacer más que sólo grabaciones en Costa Rica. Para
                            nosotros, cada proyecto es una oportunidad para
                            dejar nuestra huella en la música y dar lo mejor de
                            nosotros. Queremos que cada canción lleve nuestro
                            ADN y transmita nuestro compromiso con la calidad y
                            la excelencia. Es nuestra misión de vida, y es con
                            este espíritu que trabajamos para brindar a nuestros
                            clientes la confianza de saber que están en buenas
                            manos.
                        </p>
                    }
                />
