        ...
        <div className="BotonesAppMusic">
            {
                ...
                <div className={`BotonesAppMusic__elementos-info-reproductor ${clickInfoButton ? 'selected' : ''}`} >
                    ...
                    <li>
                            ...
                            <Link href={formatLink(`/cancion/${infoProduccion.id}`)}>
                        ...
                        <li>
                                ...
                                <Link href={formatLink(`/artista/${infoProduccion.nombre_artista}`)}>
                ...
                <div className={`BotonesAppMusic__elementos-info-reproductor ${clickInfoButton ? 'selected' : ''}`} >
                    <ul>
                        <li>
                            ...
                            <Link href={formatLink(`/instrumental/${infoProduccion.id}`)}>
                                <IconPlaylist  size={15}/>
                        ...
                        <li>
                                ...
                                <Link href={formatLink(`/productor-musical/${infoProduccion.nombre_artista}`)}>
                                    <IconMicrophone size={15} />
