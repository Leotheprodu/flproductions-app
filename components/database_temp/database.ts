export const testimonios = [
    {
        imagen: 'https://flproductionscr.com/build_main/img/artistas/blackstyle1.webp',
    ...
    {
        imagen: 'https://flproductionscr.com/build_main/img/artistas/rousses1.webp',
        nombre: 'Rousses',
    ...
    {
        imagen: 'https://flproductionscr.com/build_main/img/artistas/cesarjs1.webp',
        nombre: 'Cesar JS',
...
export const fotosDelEstudio: ImageStudio[] = [
    ...
    {
        src: 'https://flproductionscr.com/build_main/img/foto-estudio2.webp',
        width: 1249,
        height: 937,
        alt: 'foto del estudio',
        title: 'Setup del estudio',
    ...
    {
        src: 'https://flproductionscr.com/build_main/img/foto-estudio3.webp',
        width: 6000,
        height: 4000,
        alt: 'foto del estudio',
...
export const mainBannerSlider = [
    {
        img_link:
            'https://flproductionscr.com/build_main/img/banners/music/28.webp',
